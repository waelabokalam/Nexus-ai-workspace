...
const abilities = [
  { label: "Explain Nexus", icon: MessageSquareText },
      ...
      <div className="mx-auto max-w-7xl">
        <SectionReveal className="nexus-surface grid overflow-hidden rounded-[var(--nexus-radius-surface)] lg:grid-cols-[1.05fr_0.95fr]">
          <div className="p-6 sm:p-9 lg:p-12">
            ...
            <p className="nexus-copy mt-5 max-w-xl text-base leading-7">Describe your operation, ask what Nexus can support, or explore the live communication workflow.</p>
            <Link className="nexus-button-primary nexus-focus mt-8 inline-flex min-h-12 items-center justify-center rounded-[var(--nexus-radius-control)] px-5 text-sm font-medium" href="/demo/support">Talk to Nexus <ArrowRight aria-hidden="true" className="ml-2 size-4" strokeWidth={1.6} /></Link>
          </div>
          ...
          <div className="border-t border-[var(--nexus-border)] bg-[var(--nexus-surface-soft)] p-6 sm:p-9 lg:border-l lg:border-t-0 lg:p-12">
            ...
            <p className="nexus-subtle mt-6 text-xs leading-5">The public agent uses the existing Nexus Engine. Responses and workflow events are streamed through the server-side proxy.</p>
          </div>
        </SectionReveal>
      </div>
    </section>
