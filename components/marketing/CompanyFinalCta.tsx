  ...
  return (
    <section className="border-t border-[var(--nexus-border)] px-5 py-20 sm:px-8 sm:py-24">
      <SectionReveal className="mx-auto flex max-w-7xl flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Link className="nexus-button-primary nexus-focus inline-flex min-h-12 shrink-0 items-center justify-center rounded-[var(--nexus-radius-control)] px-5 text-sm font-medium" href="/contact">Talk to TQEN <span aria-hidden="true" className="ml-2">→</span></Link>
      </SectionReveal>
    </section>
  );
}
