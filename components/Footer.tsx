  ...
  return (
    <footer className="relative z-10 border-t border-white/[0.08]">
      <div className="mx-auto flex max-w-7xl flex-col justify-between gap-6 border-b border-white/[0.08] px-5 py-12 sm:px-8 md:flex-row md:items-end">
        <div><p className="text-xs font-medium uppercase tracking-[0.16em] text-zinc-500">TQEN workspace</p><h2 className="mt-3 font-heading text-2xl font-medium tracking-[-0.04em] text-white">See the operating layer in action.</h2></div>
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-[1.4fr_repeat(3,1fr)]">
        <div>
          <Link aria-label="TQEN home" className="nexus-focus inline-flex items-center gap-3 rounded-lg text-sm font-semibold tracking-[-0.03em] text-white" href="/">
            <TqMonogram size={30} /> TQEN
          </Link>
          <p className="mt-4 max-w-xs text-sm leading-6 text-zinc-400">Intelligent systems for real business operations.</p>
        </div>
        {groups.map((group) => (
