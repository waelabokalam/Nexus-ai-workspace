...
export const restaurantsAr: RestaurantsCopy = {
  ...
  intelligence: {
    ...
    reputationCopy: "تُطبَّع التقييمات إلى مشاعر ومواضيع ودرجات خطورة. تصبح المواضيع السلبية المتكررة مرئية، وتبقى المسائل عالية الخطورة قرارات بشرية.",
  ...
  integration: {
    ...
    copy: "يمكن أن تربط TQEN أنظمة المطاعم الحالية عبر موائمات المزودين. لا ندّعي أي تكامل قبل تهيئته والتحقق منه.",
    ...
    nextCopy: "تُنفَّذ هذه الربوط فقط بعد تأكيد الوصول والنطاق وسلوك المزود.",
