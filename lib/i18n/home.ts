...
export const homeAr: HomeCopy = {
  hero: {
    eyebrow: "TQEN · أنظمة ذكية لعمليات الأعمال الحقيقية",
    titleA: "أنظمة ذكية.",
  ...
  flagship: {
    ...
    copy: "يجمع مركز قيادة المدير الاستثناءات التشغيلية والموافقات وإشارات السمعة وتكاليف الموردين في شاشة مراجعة واحدة. تراقب TQEN العمليات وتُظهر ما تغيّر، وما هو شاذ، وما يحتاج مديراً أو مالكاً أو لا أحد.",
    capabilities: [
  ...
  proof: {
    ...
    copy: "منتجنا الرئيسي، وعلامات تجارية بنينا لها.",
