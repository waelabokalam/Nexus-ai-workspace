    ...
    <MarketingPage>
      <section className="mx-auto max-w-6xl px-5 pb-24 pt-20 sm:px-8 sm:pt-28">
        <div className="max-w-3xl">
          <p className="text-xs font-medium uppercase tracking-[0.16em] text-zinc-400">Capabilities</p>
        ...
        <div className="mt-20 border-t border-white/[0.1] pt-8">
          <Link className="nexus-focus inline-flex min-h-11 items-center rounded-[var(--nexus-radius-control)] bg-white px-5 text-sm font-medium text-zinc-950 transition hover:bg-zinc-200" href="/demo">See the live workspace</Link>
        </div>
      </section>
    </MarketingPage>
  );
