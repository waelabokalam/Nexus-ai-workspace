...
export const metadata: Metadata = pageMetadata("Contact", "Tell TQEN how your business works and discuss the right operational system, pilot or product scope.", "/contact");
    ...
    <MarketingPage>
      <section className="mx-auto max-w-7xl px-5 pb-24 pt-20 sm:px-8 sm:pt-28">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          <div>
            <p className="nexus-subtle text-xs font-medium uppercase tracking-[0.16em]">Talk to TQEN</p>
          ...
          {contactEmail ? (
            ...
            <>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link className="nexus-button-primary nexus-focus inline-flex min-h-11 items-center rounded-[var(--nexus-radius-control)] px-4 text-sm font-medium" href="/demo/support">Talk to the TQEN Agent</Link>
